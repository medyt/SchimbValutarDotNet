    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    BuyingEuroToRon = table.Column<float>(nullable: false),
                    BuyingGbpToRon = table.Column<float>(nullable: false),
                    BuyingUsdToRon = table.Column<float>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false),
                    SellingEuroToRon = table.Column<float>(nullable: false),
                    SellingGbpToRon = table.Column<float>(nullable: false),
                    SellingUsdToRon = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
